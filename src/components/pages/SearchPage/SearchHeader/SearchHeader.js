...
const searchHeader = (props) => (
    <div className="searchPage__header">
        <div className="searchPage__col--one">
            <img className="searchPage__logo--img" src="https://pixture.s3.amazonaws.com/photo-camera.svg" />
        ...
        <div className="searchPage__col--two">
            <form 
                ...
                <button className="material-icons searchPage__form--btn">search</button>
            </form>
            {/* 
